...
(function () {
  ...
  var TR = {
    ...
    "The first cities: tens of thousands under a single apex, fed by temple granaries and ruled by a priesthood that can read and write.": ["Les primeres ciutats: desenes de milers sota un únic vèrtex, alimentades pels graners del temple i governades per un sacerdoci que sap llegir i escriure.", "Las primeras ciudades: decenas de miles bajo un único vértice, alimentadas por los graneros del templo y gobernadas por un sacerdocio que sabe leer y escribir.", "Les premières villes : des dizaines de milliers sous un seul sommet, nourries par les greniers du temple et gouvernées par un clergé qui sait lire et écrire.", "De eerste steden: tienduizenden onder één top, gevoed door tempelgraanschuren en geregeerd door een priesterschap dat kan lezen en schrijven.", "De første byene: titusener under én topp, fôret av tempelets kornlager og styrt av et presteskap som kan lese og skrive."],
    "Empires of tens of millions, held together by written law, coined money and a professional army — resting on a vast enslaved workforce.": ["Imperis de desenes de milions, units per la llei escrita, la moneda encunyada i un exèrcit professional — sostinguts per una immensa força de treball esclavitzada.", "Imperios de decenas de millones, unidos por la ley escrita, la moneda acuñada y un ejército profesional — sostenidos por una inmensa fuerza de trabajo esclavizada.", "Des empires de dizaines de millions, tenus par la loi écrite, la monnaie frappée et une armée professionnelle — reposant sur une vaste main-d'œuvre asservie.", "Rijken van tientallen miljoenen, bijeengehouden door geschreven recht, gemunt geld en een beroepsleger — rustend op een enorme tot slaaf gemaakte beroepsbevolking.", "Imperier på titalls millioner, holdt sammen av skreven lov, preget mynt og en profesjonell hær — hvilende på en enorm slavebundet arbeidsstyrke."],
    "Power fragments into the land itself: each lord owns, judges and defends his own manor, while peasants are bound to the soil they work.": ["El poder es fragmenta en la terra mateixa: cada senyor posseeix, jutja i defensa el seu propi feu, mentre els pagesos estan lligats a la terra que treballen.", "El poder se fragmenta en la tierra misma: cada señor posee, juzga y defiende su propio feudo, mientras los campesinos están ligados a la tierra que trabajan.", "Le pouvoir se fragmente dans la terre elle-même : chaque seigneur possède, juge et défend son propre domaine, tandis que les paysans sont liés à la terre qu'ils travaillent.", "Macht versplintert in het land zelf: elke heer bezit, berecht en verdedigt zijn eigen landgoed, terwijl boeren gebonden zijn aan de grond die ze bewerken.", "Makten fragmenteres i selve jorda: hver herre eier, dømmer og forsvarer sitt eget gods, mens bøndene er bundet til jorda de dyrker."],
    "Chartered companies with their own fleets and armies span four continents, financed by an Atlantic economy of plantation slavery.": ["Companyies privilegiades amb les seves pròpies flotes i exèrcits abasten quatre continents, finançades per una economia atlàntica d'esclavitud de plantació.", "Compañías privilegiadas con sus propias flotas y ejércitos abarcan cuatro continentes, financiadas por una economía atlántica de esclavitud de plantación.", "Des compagnies à charte dotées de leurs propres flottes et armées s'étendent sur quatre continents, financées par une économie atlantique d'esclavage de plantation.", "Handelscompagnieën met eigen vloten en legers beslaan vier continenten, gefinancierd door een Atlantische economie van plantageslavernij.", "Privilegerte selskaper med egne flåter og hærer spenner over fire kontinenter, finansiert av en atlantisk økonomi av plantasjeslaveri."],
    "Factories, wage labour and the nation-state. Ownership and management split into separate hands for the first time.": ["Fàbriques, treball assalariat i l’estat nació. La propietat i la gestió se separen en mans diferents per primera vegada.", "Fábricas, trabajo asalariado y el estado nación. La propiedad y la gestión se separan en manos distintas por primera vez.", "Usines, travail salarié et État-nation. La propriété et la gestion se séparent en des mains distinctes pour la première fois.", "Fabrieken, loonarbeid en de natiestaat. Eigendom en management splitsen voor het eerst in aparte handen.", "Fabrikker, lønnsarbeid og nasjonalstaten. Eierskap og ledelse deler seg i ulike hender for første gang."],
    "One connected species and a roughly $110-trillion economy — formal equality at the ballot box above a steep concentration of wealth.": ["Una espècie connectada i una economia d'uns 110 bilions de dòlars — igualtat formal a les urnes per damunt d'una forta concentració de riquesa.", "Una especie conectada y una economía de unos 110 billones de dólares — igualdad formal en las urnas por encima de una fuerte concentración de riqueza.", "Une espèce connectée et une économie d'environ 110 000 milliards de dollars — égalité formelle dans les urnes au-dessus d'une forte concentration de richesse.", "Eén verbonden soort en een economie van zo'n 110 biljoen dollar — formele gelijkheid bij de stembus boven een sterke concentratie van rijkdom.", "Én sammenkoblet art og en økonomi på rundt 110 billioner dollar — formell likhet ved valgurnen over en sterk konsentrasjon av rikdom."],
    ...
    "A few dozen people, and no one in charge for long. Leadership rotates by task — a hunt leader, a healer, a voice in council — then dissolves.": ["Unes poques dotzenes de persones, i ningú al capdavant gaire temps. El lideratge rota per tasca — un cap de cacera, un guaridor, una veu al consell — i després es dissol.", "Unas pocas docenas de personas, y nadie al mando por mucho tiempo. El liderazgo rota por tarea — un líder de caza, un sanador, una voz en el consejo — y luego se disuelve.", "Quelques dizaines de personnes, et personne aux commandes pour longtemps. Le leadership tourne selon la tâche — un chef de chasse, un guérisseur, une voix au conseil — puis se dissout.", "Een paar dozijn mensen, en niemand lang de baas. Leiderschap rouleert per taak — een jachtleider, een genezer, een stem in de raad — en lost dan op.", "Noen få dusin mennesker, og ingen som styrer lenge. Lederskap roterer etter oppgave — en jaktleder, en helbreder, en stemme i rådet — og oppløses så."],
